...
import com.talk.domain.Talk;
import com.talk.domain.TalkBean;
import com.talk.domain.TalkBean.WsBean;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SpeechUtility.createUtility(this, SpeechConstant.APPID + "=576951fb");
	...
	private void processTalk(String talk, boolean isLast) {
		Gson gson = new Gson();
		TalkBean mTalkBean = gson.fromJson(talk, TalkBean.class);
